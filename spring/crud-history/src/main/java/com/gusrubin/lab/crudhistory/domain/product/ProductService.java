...
public class ProductService implements ProductCrudUseCase {
	...
	@LogInHistory(context = "product", action = ActionType.CREATE)
	@Override
	...
	@LogInHistory(context = "product", action = ActionType.UPDATE)
	@Override
	...
	@LogInHistory(context = "product", action = ActionType.DELETE)
	@Override
